...
/* Macro -----------------------------------------------------------------------------------*/
#define PPI_TASKS_CHG_EN(__CHG)   PPIx->TASKS_CHG[__CHG].EN    // Enable channel group x
#define PPI_TASKS_CHG_DIS(__CHG)  PPIx->TASKS_CHG[__CHG].DIS   // Disable channel group x
